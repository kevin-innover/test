...
namespace BranD10.Pages
{
    public partial class RankingDetail : System.Web.UI.Page
    {
        ...
        {
            var objs = DB.Context.From<Model.Brandranking>();
            ...
            List<Brandranking> allRanking = objs.Page(pageSize, pageIndex).ToList();
        ...
        {
            entityCount = DB.Context.Count<Model.Brandranking>("");
